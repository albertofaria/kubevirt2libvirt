...
replace (
	...
	kubevirt.io/api v0.0.0-00010101000000-000000000000 => kubevirt.io/api v1.2.0
	kubevirt.io/client-go v0.0.0-00010101000000-000000000000 => kubevirt.io/client-go v1.2.0
